  ...
  render() {
    return (
      <div>
        ...
        {this.state.filter === ''? <ContactList data={this.state.contacts} deleteContact={this.deleteContact} /> : <ContactList data={this.filterHandler()} deleteContact={this.deleteContact}
                />}
